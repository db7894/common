...
namespace Bashwork.General.Validation.Tests
{
	...
	public class ValidationContextExtensionsTests
	{
		...
		[TestMethod]
		public void ValidationContext_This_Validates()
		{
			var results = Validate.That<string>().This()
				.Obeys(value => !string.IsNullOrEmpty(value)).And()
				.Compile().Value.Validate("galen");
