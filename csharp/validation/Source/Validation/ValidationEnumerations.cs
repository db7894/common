...
namespace Bashwork.General.Validation
{
	...
	public enum CascadeMode
	{
		...
		/// <summary>
		/// Stop running the validations as soon as a single
	...
	/// <summary>
	/// Represents how detailed the reporting messages should be.
	/// </summary>
	public enum MessageLevel
	{
		/// <summary>
		/// Just indicates that the validation failed, no error messages.
		/// </summary>
		None,

		/// <summary>
		/// Returns generic messages explaining all the validation errors.
		/// </summary>
		Normal,

		/// <summary>
		/// Includes the values that failed validation
		/// </summary>
		Verbose,
	}
