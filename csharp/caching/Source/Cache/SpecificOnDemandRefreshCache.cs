...
namespace SharedAssemblies.General.Caching
{
	...
	public class SpecificOnDemandRefreshCache<TKey, TValue> : ICache<TKey, TValue>
	{
		...
		/// <param name="missing">The action to take on encountering a cache miss</param>
		public SpecificOnDemandRefreshCache(IExpirationStrategy<TValue> strategy = null,
			Func<TKey, TValue> missing = null)
		{
		...
		public TValue Get(TKey key)
		{
			...
			if (resulting.Item.IsExpired)
			{
				Statistics.Updates.Increment();
				resulting = _dictionary.AddOrUpdate(key, RegenerateMissingValue,
	...
	/// <summary>
	/// Companion object to the MultiplePullCache instance type
	/// </summary>
	public static class SpecificOnDemandRefreshCache
	{
		/// <summary>
		/// 
		/// </summary>
		...
		public static SpecificOnDemandRefreshCache<TKey, TValue> Create<TKey, TValue>(
			IExpirationStrategy<TValue> strategy, Func<TKey, TValue> missing = null)
		{
			return new SpecificOnDemandRefreshCache<TKey, TValue>(strategy, missing);
		}
	}
}
