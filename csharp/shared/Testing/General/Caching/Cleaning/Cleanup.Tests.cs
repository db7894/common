...
namespace SharedAssemblies.General.Caching.Cleaning.Tests
{
	...
	public class CleanupTests
	{
		...
		[TestMethod]
		[Ignore] // sometimes fuzzes
		public void Cleanup_NotUsedIn_Test()
		{
			var delay = Stopwatch.GetTimestamp() + TimeSpan.FromMilliseconds(250).Ticks;
			var strategy = Cleanup.NotUsedIn(Cache, TimeSpan.FromMilliseconds(1000));
