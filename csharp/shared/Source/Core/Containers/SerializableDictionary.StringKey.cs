...
namespace SharedAssemblies.Core.Containers
{
		  ...
		  IXmlSerializable
	{
		...
		public SerializableDictionary(IDictionary<string, TValue> dictionary)
			: base(dictionary)
		{
		}
		...
		/// <param name="dictionary">The dictionary to use to populate this dictionary.</param>
		public SerializableDictionary(IDictionary<string, TValue> dictionary, IEqualityComparer<string> comparer)
		...
		public void ReadXml(System.Xml.XmlReader reader)
		{
			...
			if (!wasEmpty)
			{
				...
				{
					// read the key attribute then consume rest of opening tag.
					...
					// read ending tag for entry
					reader.ReadEndElement();
				}

				// read ending tag for dictionary
				reader.ReadEndElement();
			}
		}
