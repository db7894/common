...
public abstract class SupplierProducerPair<TSupply>
    ...
    static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(SupplierProducerPair.class);
    private static final String UTF8 = "UTF8";
    // TODO private final ScheduledExecutorService executor = Executors.newSingleThreadScheduledExecutor();
